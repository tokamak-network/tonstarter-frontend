...
export function useV3DerivedMintInfo(
  ...
  useEffect(() => {
    async function getPoolInfo () {
      const pool = new Contract(BasePool_Address, UniswapV3PoolABI.abi, library)
  ...
  // return { independentField, typedValue, leftRangeTypedValue, rightRangeTypedValue, startPriceTypedValue }
  return {
    dependentField,
    currencies,
    pool,
