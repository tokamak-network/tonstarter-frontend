...
import {convertNumber, convertFromWeiToRay} from 'utils/number';
...
const getStakedBalance = async (
  ...
  return Promise.all([
    ...
    seigManager.seigManager['stakeOf(address,address)'](DEPLOYED.TokamakLayer2_ADDRESS, contractAddress),
    ...
    return {
      ...
      originalBalance: {
        ...
        stakeContractBalanceTonRay: convertFromWeiToRay(result[4]).toString(),
      },
    };
  });
};
