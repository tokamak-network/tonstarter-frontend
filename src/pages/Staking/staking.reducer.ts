  ...
  return Promise.all([
    ...
    .then((result) => {
      return {
        ...
        userStakedAmount: result[1],
        totalStakedAmount: result[2],
        totalPendingUnstakedAmount: result[3],
        stakeContractBalanceWton: result[4],
        stakeContractBalanceTon: result[5],
      };
    })
