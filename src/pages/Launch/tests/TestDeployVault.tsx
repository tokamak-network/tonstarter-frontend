...
// TODO: Write a script to auto deploy vaults after deploying the token
...
import {
  ...
  import { DeployVaultProp, encodePriceSqrt, getContract } from '@Launch/components/stepThree/DeployVault';

  
  const TestDeployVault: React.FC<DeployVaultProp> = ({vault}) => {
  ...
  export default TestDeployVault;
