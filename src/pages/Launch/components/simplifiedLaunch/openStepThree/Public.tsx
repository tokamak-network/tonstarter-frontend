  ...
  return (
    <Flex
      ...
      <Flex
        ...
        w="100%"
        alignItems={'center'}>
        <Flex w="272px" h="26px" fontSize={'12px'} mb='30px'>
          <Flex
            w="50%"
            border={
              type === 'Vault'
            ...
            justifyContent={'center'}>
            <Text color={type === 'Vault'? 'blue.300':colorMode === 'dark'?'white.100':'gray.250'}>Vault & Claim</Text>
          </Flex>
          <Flex
            w="50%"
            border={
            ...
            alignItems={'center'}
            justifyContent={'center'}>
            <Text  color={type === 'Sale'? 'blue.300':colorMode === 'dark'?'white.100':'gray.250'}>Sale</Text>
          </Flex>
        </Flex>
