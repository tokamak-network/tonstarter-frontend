  ...
  return (
    <Flex
      ...
      <Flex>
        ...
        <Tooltip
          label={
            'All contracts must be deployed before the deadline. If you fail to do so, your project will fail to launch and you will not be able to recover any gas costs incurred.'
          }
          hasArrow
          fontSize="12px"
          placement="top"
