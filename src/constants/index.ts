...
export const REACT_APP_PRICE_API = process.env.REACT_APP_PRICE_API as string;
...
export const fetchTosPriceURL = `${REACT_APP_PRICE_API}/tosprice`;
export const fetchTVLURL = `${REACT_APP_PRICE_API}/tvl`;
